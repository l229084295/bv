...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      RspSessionDetails.class.getName());
  }
  // Use RspSessionDetails.newBuilder() to construct.
  private RspSessionDetails(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return bilibili.im.interface1.v1.Im.internal_static_bilibili_im_interface_v1_RspSessionDetails_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return bilibili.im.interface1.v1.Im.internal_static_bilibili_im_interface_v1_RspSessionDetails_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            bilibili.im.interface1.v1.RspSessionDetails.class, bilibili.im.interface1.v1.RspSessionDetails.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof bilibili.im.interface1.v1.RspSessionDetails)) {
      return super.equals(obj);
    }
    bilibili.im.interface1.v1.RspSessionDetails other = (bilibili.im.interface1.v1.RspSessionDetails) obj;
  ...
  public static bilibili.im.interface1.v1.RspSessionDetails parseFrom(
  ...
  public static bilibili.im.interface1.v1.RspSessionDetails parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static bilibili.im.interface1.v1.RspSessionDetails parseFrom(
  ...
  public static bilibili.im.interface1.v1.RspSessionDetails parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static bilibili.im.interface1.v1.RspSessionDetails parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessage
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static bilibili.im.interface1.v1.RspSessionDetails parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessage
  ...
  public static Builder newBuilder(bilibili.im.interface1.v1.RspSessionDetails prototype) {
  ...
  public static final class Builder extends
      ...
      bilibili.im.interface1.v1.RspSessionDetailsOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return bilibili.im.interface1.v1.Im.internal_static_bilibili_im_interface_v1_RspSessionDetails_descriptor;
    }
    ...
    // Construct using bilibili.im.interface1.v1.RspSessionDetails.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public bilibili.im.interface1.v1.RspSessionDetails getDefaultInstanceForType() {
      return bilibili.im.interface1.v1.RspSessionDetails.getDefaultInstance();
    }

    @java.lang.Override
    public bilibili.im.interface1.v1.RspSessionDetails build() {
      bilibili.im.interface1.v1.RspSessionDetails result = buildPartial();
    ...
    @java.lang.Override
    public bilibili.im.interface1.v1.RspSessionDetails buildPartial() {
      bilibili.im.interface1.v1.RspSessionDetails result = new bilibili.im.interface1.v1.RspSessionDetails(this);
    ...
    private void buildPartialRepeatedFields(bilibili.im.interface1.v1.RspSessionDetails result) {
      if (sessInfosBuilder_ == null) {
    ...
    private void buildPartial0(bilibili.im.interface1.v1.RspSessionDetails result) {
      int from_bitField0_ = bitField0_;
    }

    @java.lang.Override
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof bilibili.im.interface1.v1.RspSessionDetails) {
        return mergeFrom((bilibili.im.interface1.v1.RspSessionDetails)other);
      } else {
    ...
    public Builder mergeFrom(bilibili.im.interface1.v1.RspSessionDetails other) {
      if (other == bilibili.im.interface1.v1.RspSessionDetails.getDefaultInstance()) return this;
      if (sessInfosBuilder_ == null) {
    ...
    private com.google.protobuf.RepeatedFieldBuilder<
      ...
      if (sessInfosBuilder_ == null) {
        sessInfosBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
            bilibili.im.type.SessionInfo, bilibili.im.type.SessionInfo.Builder, bilibili.im.type.SessionInfoOrBuilder>(
                sessInfos_,
  ...
  private static final bilibili.im.interface1.v1.RspSessionDetails DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new bilibili.im.interface1.v1.RspSessionDetails();
  }

  public static bilibili.im.interface1.v1.RspSessionDetails getDefaultInstance() {
