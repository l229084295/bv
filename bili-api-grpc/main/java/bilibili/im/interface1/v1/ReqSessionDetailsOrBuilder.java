...
public interface ReqSessionDetailsOrBuilder extends
   ...
   */
  java.util.List<bilibili.im.interface1.v1.ReqSessionDetail> 
      getSessIdsList();
  /**
   * <pre>
   * 会话详情请求列表
   ...
   * <code>repeated .bilibili.im.interface.v1.ReqSessionDetail sess_ids = 1;</code>
   */
  bilibili.im.interface1.v1.ReqSessionDetail getSessIds(int index);
  /**
   * <pre>
   * 会话详情请求列表
   * </pre>
   ...
   * <code>repeated .bilibili.im.interface.v1.ReqSessionDetail sess_ids = 1;</code>
   */
  java.util.List<? extends bilibili.im.interface1.v1.ReqSessionDetailOrBuilder> 
   ...
   * <code>repeated .bilibili.im.interface.v1.ReqSessionDetail sess_ids = 1;</code>
   */
  bilibili.im.interface1.v1.ReqSessionDetailOrBuilder getSessIdsOrBuilder(
      int index);
}
