...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      PlayDeviceConf.class.getName());
  }
  // Use PlayDeviceConf.newBuilder() to construct.
  private PlayDeviceConf(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(bilibili.playershared.PlayDeviceConf result) {
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.deviceConfs_ = internalGetDeviceConfs().build(DeviceConfsDefaultEntryHolder.defaultEntry);
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              internalGetMutableDeviceConfs().ensureBuilderMap().put(
    ...
    private static final class DeviceConfsConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.Integer, bilibili.playershared.DeviceConfOrBuilder, bilibili.playershared.DeviceConf> {
      @java.lang.Override
      public bilibili.playershared.DeviceConf build(bilibili.playershared.DeviceConfOrBuilder val) {
        if (val instanceof bilibili.playershared.DeviceConf) { return (bilibili.playershared.DeviceConf) val; }
        return ((bilibili.playershared.DeviceConf.Builder) val).build();
      }

      @java.lang.Override
      public com.google.protobuf.MapEntry<java.lang.Integer, bilibili.playershared.DeviceConf> defaultEntry() {
    ...
    private com.google.protobuf.MapFieldBuilder<
        java.lang.Integer, bilibili.playershared.DeviceConfOrBuilder, bilibili.playershared.DeviceConf, bilibili.playershared.DeviceConf.Builder> deviceConfs_;
    private com.google.protobuf.MapFieldBuilder<java.lang.Integer, bilibili.playershared.DeviceConfOrBuilder, bilibili.playershared.DeviceConf, bilibili.playershared.DeviceConf.Builder>
        internalGetDeviceConfs() {
      if (deviceConfs_ == null) {
        return new com.google.protobuf.MapFieldBuilder<>(deviceConfsConverter);
      }
      return deviceConfs_;
    }
    private com.google.protobuf.MapFieldBuilder<java.lang.Integer, bilibili.playershared.DeviceConfOrBuilder, bilibili.playershared.DeviceConf, bilibili.playershared.DeviceConf.Builder>
      ...
      if (deviceConfs_ == null) {
        deviceConfs_ = new com.google.protobuf.MapFieldBuilder<>(deviceConfsConverter);
      }
      bitField0_ |= 0x00000001;
      onChanged();
      return deviceConfs_;
    ...
    public boolean containsDeviceConfs(
      ...
      return internalGetDeviceConfs().ensureBuilderMap().containsKey(key);
    }
    /**
     * Use {@link #getDeviceConfsMap()} instead.
     */
...
bilibili.playershared.DeviceConf defaultValue) {
      ...
      java.util.Map<java.lang.Integer, bilibili.playershared.DeviceConfOrBuilder> map = internalGetMutableDeviceConfs().ensureBuilderMap();
      return map.containsKey(key) ? deviceConfsConverter.build(map.get(key)) : defaultValue;
    }
    /**
     * <pre>
     * </pre>
    ...
    public bilibili.playershared.DeviceConf getDeviceConfsOrThrow(
      ...
      return deviceConfsConverter.build(map.get(key));
    }
    ...
    public Builder removeDeviceConfs(
      ...
      internalGetMutableDeviceConfs().ensureBuilderMap()
          .remove(key);
      return this;
    }
    /**
    ...
    public Builder putAllDeviceConfs(
      ...
      for (java.util.Map.Entry<java.lang.Integer, bilibili.playershared.DeviceConf> e : values.entrySet()) {
     ...
     * <code>map&lt;int32, .bilibili.playershared.DeviceConf&gt; device_confs = 1;</code>
     */
    public bilibili.playershared.DeviceConf.Builder putDeviceConfsBuilderIfAbsent(
        int key) {
      java.util.Map<java.lang.Integer, bilibili.playershared.DeviceConfOrBuilder> builderMap = internalGetMutableDeviceConfs().ensureBuilderMap();
      bilibili.playershared.DeviceConfOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = bilibili.playershared.DeviceConf.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof bilibili.playershared.DeviceConf) {
        entry = ((bilibili.playershared.DeviceConf) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (bilibili.playershared.DeviceConf.Builder) entry;
    }
