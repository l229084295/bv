...
public interface AtGroupOrBuilder extends
   ...
   */
  java.util.List<bilibili.relation.interface1.v1.AtItem> 
      getItemsList();
  /**
   * <pre>
   * 用户列表
   ...
   * <code>repeated .bilibili.relation.interface.v1.AtItem items = 3;</code>
   */
  bilibili.relation.interface1.v1.AtItem getItems(int index);
  /**
   * <pre>
   * 用户列表
   * </pre>
   ...
   * <code>repeated .bilibili.relation.interface.v1.AtItem items = 3;</code>
   */
  java.util.List<? extends bilibili.relation.interface1.v1.AtItemOrBuilder> 
   ...
   * <code>repeated .bilibili.relation.interface.v1.AtItem items = 3;</code>
   */
  bilibili.relation.interface1.v1.AtItemOrBuilder getItemsOrBuilder(
      int index);
}
