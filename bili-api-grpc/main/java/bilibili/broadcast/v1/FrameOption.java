...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      FrameOption.class.getName());
  }
  // Use FrameOption.newBuilder() to construct.
  private FrameOption(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  private FrameOption() {
    ackOrigin_ = "";
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(ackOrigin_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, ackOrigin_);
    }
    if (timestamp_ != 0L) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(ackOrigin_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, ackOrigin_);
    }
    if (timestamp_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
