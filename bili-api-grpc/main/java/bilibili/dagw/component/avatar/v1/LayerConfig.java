...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      LayerConfig.class.getName());
  }
  // Use LayerConfig.newBuilder() to construct.
  private LayerConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  private LayerConfig() {
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(bilibili.dagw.component.avatar.v1.LayerConfig result) {
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.tags_ = internalGetTags().build(TagsDefaultEntryHolder.defaultEntry);
      }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              internalGetMutableTags().ensureBuilderMap().put(
    ...
    private static final class TagsConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.String, bilibili.dagw.component.avatar.v1.LayerTagConfigOrBuilder, bilibili.dagw.component.avatar.v1.LayerTagConfig> {
      @java.lang.Override
      public bilibili.dagw.component.avatar.v1.LayerTagConfig build(bilibili.dagw.component.avatar.v1.LayerTagConfigOrBuilder val) {
        if (val instanceof bilibili.dagw.component.avatar.v1.LayerTagConfig) { return (bilibili.dagw.component.avatar.v1.LayerTagConfig) val; }
        return ((bilibili.dagw.component.avatar.v1.LayerTagConfig.Builder) val).build();
      }

      @java.lang.Override
      public com.google.protobuf.MapEntry<java.lang.String, bilibili.dagw.component.avatar.v1.LayerTagConfig> defaultEntry() {
        return TagsDefaultEntryHolder.defaultEntry;
      }
    };
    private static final TagsConverter tagsConverter = new TagsConverter();

    private com.google.protobuf.MapFieldBuilder<
        java.lang.String, bilibili.dagw.component.avatar.v1.LayerTagConfigOrBuilder, bilibili.dagw.component.avatar.v1.LayerTagConfig, bilibili.dagw.component.avatar.v1.LayerTagConfig.Builder> tags_;
    private com.google.protobuf.MapFieldBuilder<java.lang.String, bilibili.dagw.component.avatar.v1.LayerTagConfigOrBuilder, bilibili.dagw.component.avatar.v1.LayerTagConfig, bilibili.dagw.component.avatar.v1.LayerTagConfig.Builder>
        internalGetTags() {
      if (tags_ == null) {
        return new com.google.protobuf.MapFieldBuilder<>(tagsConverter);
      }
      return tags_;
    }
    private com.google.protobuf.MapFieldBuilder<java.lang.String, bilibili.dagw.component.avatar.v1.LayerTagConfigOrBuilder, bilibili.dagw.component.avatar.v1.LayerTagConfig, bilibili.dagw.component.avatar.v1.LayerTagConfig.Builder>
      ...
      if (tags_ == null) {
        tags_ = new com.google.protobuf.MapFieldBuilder<>(tagsConverter);
      }
      bitField0_ |= 0x00000001;
      onChanged();
      return tags_;
    ...
    public int getTagsCount() {
      return internalGetTags().ensureBuilderMap().size();
    }
    /**
     * <pre>
     * </pre>
    ...
    public boolean containsTags(
        java.lang.String key) {
      if (key == null) { throw new NullPointerException("map key"); }
      return internalGetTags().ensureBuilderMap().containsKey(key);
    }
    /**
     * Use {@link #getTagsMap()} instead.
     */
    ...
    @java.lang.Override
    public java.util.Map<java.lang.String, bilibili.dagw.component.avatar.v1.LayerTagConfig> getTagsMap() {
      return internalGetTags().getImmutableMap();
    }
    /**
     * <pre>
     * </pre>
...
bilibili.dagw.component.avatar.v1.LayerTagConfig defaultValue) {
      if (key == null) { throw new NullPointerException("map key"); }
      java.util.Map<java.lang.String, bilibili.dagw.component.avatar.v1.LayerTagConfigOrBuilder> map = internalGetMutableTags().ensureBuilderMap();
      return map.containsKey(key) ? tagsConverter.build(map.get(key)) : defaultValue;
    }
    /**
     * <pre>
     * </pre>
    ...
    public bilibili.dagw.component.avatar.v1.LayerTagConfig getTagsOrThrow(
      ...
      return tagsConverter.build(map.get(key));
    }
    ...
    public Builder removeTags(
        java.lang.String key) {
      if (key == null) { throw new NullPointerException("map key"); }
      internalGetMutableTags().ensureBuilderMap()
          .remove(key);
      return this;
    }
    /**
    ...
    public java.util.Map<java.lang.String, bilibili.dagw.component.avatar.v1.LayerTagConfig>
        getMutableTags() {
      bitField0_ |= 0x00000001;
      return internalGetMutableTags().ensureMessageMap();
    }
    /**
     * <pre>
     * </pre>
    ...
    public Builder putAllTags(
      ...
      for (java.util.Map.Entry<java.lang.String, bilibili.dagw.component.avatar.v1.LayerTagConfig> e : values.entrySet()) {
     ...
     * <code>map&lt;string, .bilibili.dagw.component.avatar.v1.LayerTagConfig&gt; tags = 1;</code>
     */
    public bilibili.dagw.component.avatar.v1.LayerTagConfig.Builder putTagsBuilderIfAbsent(
        java.lang.String key) {
      java.util.Map<java.lang.String, bilibili.dagw.component.avatar.v1.LayerTagConfigOrBuilder> builderMap = internalGetMutableTags().ensureBuilderMap();
      bilibili.dagw.component.avatar.v1.LayerTagConfigOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = bilibili.dagw.component.avatar.v1.LayerTagConfig.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof bilibili.dagw.component.avatar.v1.LayerTagConfig) {
        entry = ((bilibili.dagw.component.avatar.v1.LayerTagConfig) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (bilibili.dagw.component.avatar.v1.LayerTagConfig.Builder) entry;
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        getLayerMaskFieldBuilder() {
      if (layerMaskBuilder_ == null) {
        layerMaskBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            bilibili.dagw.component.avatar.common.MaskProperty, bilibili.dagw.component.avatar.common.MaskProperty.Builder, bilibili.dagw.component.avatar.common.MaskPropertyOrBuilder>(
                getLayerMask(),
