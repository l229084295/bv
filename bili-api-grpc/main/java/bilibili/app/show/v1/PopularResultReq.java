...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      PopularResultReq.class.getName());
  }
  // Use PopularResultReq.newBuilder() to construct.
  private PopularResultReq(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(spmid_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, spmid_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(lastParam_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 9, lastParam_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(ver_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 10, ver_);
    }
    if (entranceId_ != 0L) {
      output.writeInt64(11, entranceId_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(locationIds_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 12, locationIds_);
    }
    if (sourceId_ != 0) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(spmid_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, spmid_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(lastParam_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(9, lastParam_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(ver_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(10, ver_);
    }
    if (entranceId_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(locationIds_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(12, locationIds_);
    }
    if (sourceId_ != 0) {
      size += com.google.protobuf.CodedOutputStream
