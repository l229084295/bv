...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      DynSpaceSearchDetailsReply.class.getName());
  }
  // Use DynSpaceSearchDetailsReply.newBuilder() to construct.
  private DynSpaceSearchDetailsReply(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
...
bilibili.app.dynamic.v2.DynamicItem defaultValue) {
  ...
  public static final class Builder extends
    ...
    private static final class ItemsConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.Long, bilibili.app.dynamic.v2.DynamicItemOrBuilder, bilibili.app.dynamic.v2.DynamicItem> {
      @java.lang.Override
      public bilibili.app.dynamic.v2.DynamicItem build(bilibili.app.dynamic.v2.DynamicItemOrBuilder val) {
        if (val instanceof bilibili.app.dynamic.v2.DynamicItem) { return (bilibili.app.dynamic.v2.DynamicItem) val; }
        return ((bilibili.app.dynamic.v2.DynamicItem.Builder) val).build();
      }

      @java.lang.Override
      public com.google.protobuf.MapEntry<java.lang.Long, bilibili.app.dynamic.v2.DynamicItem> defaultEntry() {
    ...
    private com.google.protobuf.MapFieldBuilder<
        java.lang.Long, bilibili.app.dynamic.v2.DynamicItemOrBuilder, bilibili.app.dynamic.v2.DynamicItem, bilibili.app.dynamic.v2.DynamicItem.Builder> items_;
    private com.google.protobuf.MapFieldBuilder<java.lang.Long, bilibili.app.dynamic.v2.DynamicItemOrBuilder, bilibili.app.dynamic.v2.DynamicItem, bilibili.app.dynamic.v2.DynamicItem.Builder>
        internalGetItems() {
      if (items_ == null) {
...
bilibili.app.dynamic.v2.DynamicItem defaultValue) {
      ...
      java.util.Map<java.lang.Long, bilibili.app.dynamic.v2.DynamicItemOrBuilder> map = internalGetMutableItems().ensureBuilderMap();
    ...
    public Builder putAllItems(
      ...
      for (java.util.Map.Entry<java.lang.Long, bilibili.app.dynamic.v2.DynamicItem> e : values.entrySet()) {
     ...
     * <code>map&lt;int64, .bilibili.app.dynamic.v2.DynamicItem&gt; items = 1;</code>
     */
    public bilibili.app.dynamic.v2.DynamicItem.Builder putItemsBuilderIfAbsent(
        long key) {
      java.util.Map<java.lang.Long, bilibili.app.dynamic.v2.DynamicItemOrBuilder> builderMap = internalGetMutableItems().ensureBuilderMap();
      bilibili.app.dynamic.v2.DynamicItemOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = bilibili.app.dynamic.v2.DynamicItem.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof bilibili.app.dynamic.v2.DynamicItem) {
        entry = ((bilibili.app.dynamic.v2.DynamicItem) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (bilibili.app.dynamic.v2.DynamicItem.Builder) entry;
    }
