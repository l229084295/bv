...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      IconBadge.class.getName());
  }
  // Use IconBadge.newBuilder() to construct.
  private IconBadge(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  private IconBadge() {
    iconBgUrl_ = "";
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(iconBgUrl_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, iconBgUrl_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(iconBgUrl_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, iconBgUrl_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(text_)) {
