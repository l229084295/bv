...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      ThreePointWait.class.getName());
  }
  // Use ThreePointWait.newBuilder() to construct.
  private ThreePointWait(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(additionIcon_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, additionIcon_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(additionText_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, additionText_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(noAdditionIcon_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, noAdditionIcon_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(noAdditionText_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, noAdditionText_);
    }
    if (id_ != 0L) {
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(additionIcon_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, additionIcon_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(additionText_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, additionText_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(noAdditionIcon_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, noAdditionIcon_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(noAdditionText_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, noAdditionText_);
    }
    if (id_ != 0L) {
