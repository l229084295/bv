...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      DynThumbReq.class.getName());
  }
  // Use DynThumbReq.newBuilder() to construct.
  private DynThumbReq(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  private DynThumbReq() {
    dynId_ = "";
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(dynId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, dynId_);
    }
    if (dynType_ != 0L) {
      output.writeInt64(3, dynType_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(rid_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, rid_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(dynId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, dynId_);
    }
    if (dynType_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(rid_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, rid_);
    }
    if (type_ != bilibili.dynamic.gateway.ThumbType.cancel.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
