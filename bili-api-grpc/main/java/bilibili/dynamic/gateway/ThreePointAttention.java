...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      ThreePointAttention.class.getName());
  }
  // Use ThreePointAttention.newBuilder() to construct.
  private ThreePointAttention(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(attentionIcon_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, attentionIcon_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(attentionText_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, attentionText_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(notAttentionIcon_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, notAttentionIcon_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(notAttentionText_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, notAttentionText_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(attentionIcon_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, attentionIcon_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(attentionText_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, attentionText_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(notAttentionIcon_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, notAttentionIcon_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(notAttentionText_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, notAttentionText_);
    }
    if (status_ != bilibili.dynamic.gateway.ThreePointAttentionStatus.tp_not_attention.getNumber()) {
