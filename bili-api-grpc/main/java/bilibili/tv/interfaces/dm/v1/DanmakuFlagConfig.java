...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      DanmakuFlagConfig.class.getName());
  }
  // Use DanmakuFlagConfig.newBuilder() to construct.
  private DanmakuFlagConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(recText_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, recText_);
    }
    if (recSwitch_ != 0) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(recText_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, recText_);
    }
    if (recSwitch_ != 0) {
      size += com.google.protobuf.CodedOutputStream
