...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      DeviceAppList.class.getName());
  }
  // Use DeviceAppList.newBuilder() to construct.
  private DeviceAppList(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < systemAppList_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, systemAppList_.getRaw(i));
    }
    for (int i = 0; i < userAppList_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, userAppList_.getRaw(i));
    }
