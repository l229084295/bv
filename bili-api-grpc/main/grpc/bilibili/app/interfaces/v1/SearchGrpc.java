...
public final class SearchGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.interfaces.v1.SuggestionResult3Req,
      bilibili.app.interfaces.v1.SuggestionResult3Reply> getSuggest3Method;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Suggest3",
      requestType = bilibili.app.interfaces.v1.SuggestionResult3Req.class,
      responseType = bilibili.app.interfaces.v1.SuggestionResult3Reply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.interfaces.v1.SuggestionResult3Req,
      bilibili.app.interfaces.v1.SuggestionResult3Reply> getSuggest3Method() {
    io.grpc.MethodDescriptor<bilibili.app.interfaces.v1.SuggestionResult3Req, bilibili.app.interfaces.v1.SuggestionResult3Reply> getSuggest3Method;
      ...
      synchronized (SearchGrpc.class) {
        if ((getSuggest3Method = SearchGrpc.getSuggest3Method) == null) {
          SearchGrpc.getSuggest3Method = getSuggest3Method =
              io.grpc.MethodDescriptor.<bilibili.app.interfaces.v1.SuggestionResult3Req, bilibili.app.interfaces.v1.SuggestionResult3Reply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Suggest3"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.interfaces.v1.SuggestionResult3Req.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.interfaces.v1.SuggestionResult3Reply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.interfaces.v1.DefaultWordsReq,
      bilibili.app.interfaces.v1.DefaultWordsReply> getDefaultWordsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DefaultWords",
      requestType = bilibili.app.interfaces.v1.DefaultWordsReq.class,
      responseType = bilibili.app.interfaces.v1.DefaultWordsReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.interfaces.v1.DefaultWordsReq,
      bilibili.app.interfaces.v1.DefaultWordsReply> getDefaultWordsMethod() {
    io.grpc.MethodDescriptor<bilibili.app.interfaces.v1.DefaultWordsReq, bilibili.app.interfaces.v1.DefaultWordsReply> getDefaultWordsMethod;
    if ((getDefaultWordsMethod = SearchGrpc.getDefaultWordsMethod) == null) {
      synchronized (SearchGrpc.class) {
        if ((getDefaultWordsMethod = SearchGrpc.getDefaultWordsMethod) == null) {
          SearchGrpc.getDefaultWordsMethod = getDefaultWordsMethod =
              io.grpc.MethodDescriptor.<bilibili.app.interfaces.v1.DefaultWordsReq, bilibili.app.interfaces.v1.DefaultWordsReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "DefaultWords"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.interfaces.v1.DefaultWordsReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.interfaces.v1.DefaultWordsReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void suggest3(bilibili.app.interfaces.v1.SuggestionResult3Req request,
        io.grpc.stub.StreamObserver<bilibili.app.interfaces.v1.SuggestionResult3Reply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSuggest3Method(), responseObserver);
    }

    /**
     */
    default void defaultWords(bilibili.app.interfaces.v1.DefaultWordsReq request,
        io.grpc.stub.StreamObserver<bilibili.app.interfaces.v1.DefaultWordsReply> responseObserver) {
  ...
  public static final class SearchStub
     ...
     * </pre>
     */
    public void suggest3(bilibili.app.interfaces.v1.SuggestionResult3Req request,
        io.grpc.stub.StreamObserver<bilibili.app.interfaces.v1.SuggestionResult3Reply> responseObserver) {
    ...
    /**
     */
    public void defaultWords(bilibili.app.interfaces.v1.DefaultWordsReq request,
        io.grpc.stub.StreamObserver<bilibili.app.interfaces.v1.DefaultWordsReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class SearchBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.interfaces.v1.SuggestionResult3Reply suggest3(bilibili.app.interfaces.v1.SuggestionResult3Req request) {
    ...
    /**
     */
    public bilibili.app.interfaces.v1.DefaultWordsReply defaultWords(bilibili.app.interfaces.v1.DefaultWordsReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class SearchFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.interfaces.v1.SuggestionResult3Reply> suggest3(
        bilibili.app.interfaces.v1.SuggestionResult3Req request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.interfaces.v1.DefaultWordsReply> defaultWords(
        bilibili.app.interfaces.v1.DefaultWordsReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUGGEST3:
          serviceImpl.suggest3((bilibili.app.interfaces.v1.SuggestionResult3Req) request,
              (io.grpc.stub.StreamObserver<bilibili.app.interfaces.v1.SuggestionResult3Reply>) responseObserver);
          break;
        case METHODID_DEFAULT_WORDS:
          serviceImpl.defaultWords((bilibili.app.interfaces.v1.DefaultWordsReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.interfaces.v1.DefaultWordsReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.app.interfaces.v1.SuggestionResult3Req,
              bilibili.app.interfaces.v1.SuggestionResult3Reply>(
                service, METHODID_SUGGEST3)))
        .addMethod(
          getDefaultWordsMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.app.interfaces.v1.DefaultWordsReq,
              bilibili.app.interfaces.v1.DefaultWordsReply>(
  ...
  private static abstract class SearchBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.interfaces.v1.SearchOuterClass.getDescriptor();
    }
