...
public final class InnerInterfaceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist,
      bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist> getUpdateListInnMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateListInn",
      requestType = bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist.class,
      responseType = bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist,
      bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist> getUpdateListInnMethod() {
    io.grpc.MethodDescriptor<bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist, bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist> getUpdateListInnMethod;
      ...
      synchronized (InnerInterfaceGrpc.class) {
        if ((getUpdateListInnMethod = InnerInterfaceGrpc.getUpdateListInnMethod) == null) {
          InnerInterfaceGrpc.getUpdateListInnMethod = getUpdateListInnMethod =
              io.grpc.MethodDescriptor.<bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist, bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpdateListInn"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void updateListInn(bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist request,
        io.grpc.stub.StreamObserver<bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist> responseObserver) {
  ...
  public static final class InnerInterfaceStub
    ...
    /**
     */
    public void updateListInn(bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist request,
        io.grpc.stub.StreamObserver<bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist> responseObserver) {
  ...
  public static final class InnerInterfaceBlockingStub
    ...
    /**
     */
    public bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist updateListInn(bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist request) {
  ...
  public static final class InnerInterfaceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist> updateListInn(
        bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPDATE_LIST_INN:
          serviceImpl.updateListInn((bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist) request,
              (io.grpc.stub.StreamObserver<bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.im.interfaces.inner.interface1.v1.ReqOpBlacklist,
              bilibili.im.interfaces.inner.interface1.v1.RspOpBlacklist>(
  ...
  private static abstract class InnerInterfaceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.im.interfaces.inner.interface1.v1.Api.getDescriptor();
    }
