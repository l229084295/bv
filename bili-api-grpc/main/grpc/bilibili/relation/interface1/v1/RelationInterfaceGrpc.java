...
public final class RelationInterfaceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.relation.interface1.v1.AtSearchReq,
      bilibili.relation.interface1.v1.AtSearchReply> getAtSearchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AtSearch",
      requestType = bilibili.relation.interface1.v1.AtSearchReq.class,
      responseType = bilibili.relation.interface1.v1.AtSearchReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.relation.interface1.v1.AtSearchReq,
      bilibili.relation.interface1.v1.AtSearchReply> getAtSearchMethod() {
    io.grpc.MethodDescriptor<bilibili.relation.interface1.v1.AtSearchReq, bilibili.relation.interface1.v1.AtSearchReply> getAtSearchMethod;
      ...
      synchronized (RelationInterfaceGrpc.class) {
        if ((getAtSearchMethod = RelationInterfaceGrpc.getAtSearchMethod) == null) {
          RelationInterfaceGrpc.getAtSearchMethod = getAtSearchMethod =
              io.grpc.MethodDescriptor.<bilibili.relation.interface1.v1.AtSearchReq, bilibili.relation.interface1.v1.AtSearchReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AtSearch"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.relation.interface1.v1.AtSearchReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.relation.interface1.v1.AtSearchReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void atSearch(bilibili.relation.interface1.v1.AtSearchReq request,
        io.grpc.stub.StreamObserver<bilibili.relation.interface1.v1.AtSearchReply> responseObserver) {
  ...
  public static final class RelationInterfaceStub
     ...
     * </pre>
     */
    public void atSearch(bilibili.relation.interface1.v1.AtSearchReq request,
        io.grpc.stub.StreamObserver<bilibili.relation.interface1.v1.AtSearchReply> responseObserver) {
  ...
  public static final class RelationInterfaceBlockingStub
     ...
     * </pre>
     */
    public bilibili.relation.interface1.v1.AtSearchReply atSearch(bilibili.relation.interface1.v1.AtSearchReq request) {
  ...
  public static final class RelationInterfaceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.relation.interface1.v1.AtSearchReply> atSearch(
        bilibili.relation.interface1.v1.AtSearchReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AT_SEARCH:
          serviceImpl.atSearch((bilibili.relation.interface1.v1.AtSearchReq) request,
              (io.grpc.stub.StreamObserver<bilibili.relation.interface1.v1.AtSearchReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.relation.interface1.v1.AtSearchReq,
              bilibili.relation.interface1.v1.AtSearchReply>(
  ...
  private static abstract class RelationInterfaceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.relation.interface1.v1.Api.getDescriptor();
    }
