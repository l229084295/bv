...
public inline fun danmuDefaultPlayerConfig(block: bilibili.community.service.dm.v1.DanmuDefaultPlayerConfigKt.Dsl.() -> kotlin.Unit): bilibili.community.service.dm.v1.DanmuDefaultPlayerConfig =
  bilibili.community.service.dm.v1.DanmuDefaultPlayerConfigKt.Dsl._create(bilibili.community.service.dm.v1.DanmuDefaultPlayerConfig.newBuilder()).apply { block() }._build()
/**
 * ```
 * 弹幕默认配置
 * ```
 *
 * Protobuf type `bilibili.community.service.dm.v1.DanmuDefaultPlayerConfig`
 */
public object DanmuDefaultPlayerConfigKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: bilibili.community.service.dm.v1.DanmuDefaultPlayerConfig.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: bilibili.community.service.dm.v1.DanmuDefaultPlayerConfig.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): bilibili.community.service.dm.v1.DanmuDefaultPlayerConfig = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun bilibili.community.service.dm.v1.DanmuDefaultPlayerConfig.copy(block: `bilibili.community.service.dm.v1`.DanmuDefaultPlayerConfigKt.Dsl.() -> kotlin.Unit): bilibili.community.service.dm.v1.DanmuDefaultPlayerConfig =
  `bilibili.community.service.dm.v1`.DanmuDefaultPlayerConfigKt.Dsl._create(this.toBuilder()).apply { block() }._build()
