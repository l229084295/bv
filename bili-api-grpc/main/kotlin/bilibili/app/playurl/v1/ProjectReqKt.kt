...
public inline fun projectReq(block: bilibili.app.playurl.v1.ProjectReqKt.Dsl.() -> kotlin.Unit): bilibili.app.playurl.v1.ProjectReq =
  bilibili.app.playurl.v1.ProjectReqKt.Dsl._create(bilibili.app.playurl.v1.ProjectReq.newBuilder()).apply { block() }._build()
/**
 * ```
 * 投屏地址-请求
 * ```
 *
 * Protobuf type `bilibili.app.playurl.v1.ProjectReq`
 */
public object ProjectReqKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: bilibili.app.playurl.v1.ProjectReq.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: bilibili.app.playurl.v1.ProjectReq.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): bilibili.app.playurl.v1.ProjectReq = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun bilibili.app.playurl.v1.ProjectReq.copy(block: `bilibili.app.playurl.v1`.ProjectReqKt.Dsl.() -> kotlin.Unit): bilibili.app.playurl.v1.ProjectReq =
  `bilibili.app.playurl.v1`.ProjectReqKt.Dsl._create(this.toBuilder()).apply { block() }._build()
