...
public inline fun videoBadge(block: bilibili.app.dynamic.v2.VideoBadgeKt.Dsl.() -> kotlin.Unit): bilibili.app.dynamic.v2.VideoBadge =
  bilibili.app.dynamic.v2.VideoBadgeKt.Dsl._create(bilibili.app.dynamic.v2.VideoBadge.newBuilder()).apply { block() }._build()
/**
 * ```
 * 角标信息
 * ```
 *
 * Protobuf type `bilibili.app.dynamic.v2.VideoBadge`
 */
public object VideoBadgeKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: bilibili.app.dynamic.v2.VideoBadge.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: bilibili.app.dynamic.v2.VideoBadge.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): bilibili.app.dynamic.v2.VideoBadge = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun bilibili.app.dynamic.v2.VideoBadge.copy(block: `bilibili.app.dynamic.v2`.VideoBadgeKt.Dsl.() -> kotlin.Unit): bilibili.app.dynamic.v2.VideoBadge =
  `bilibili.app.dynamic.v2`.VideoBadgeKt.Dsl._create(this.toBuilder()).apply { block() }._build()
