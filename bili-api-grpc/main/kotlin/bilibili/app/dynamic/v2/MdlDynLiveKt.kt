...
public inline fun mdlDynLive(block: bilibili.app.dynamic.v2.MdlDynLiveKt.Dsl.() -> kotlin.Unit): bilibili.app.dynamic.v2.MdlDynLive =
  bilibili.app.dynamic.v2.MdlDynLiveKt.Dsl._create(bilibili.app.dynamic.v2.MdlDynLive.newBuilder()).apply { block() }._build()
/**
 * ```
 * 动态列表渲染部分-详情模块-直播
 * ```
 *
 * Protobuf type `bilibili.app.dynamic.v2.MdlDynLive`
 */
public object MdlDynLiveKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: bilibili.app.dynamic.v2.MdlDynLive.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: bilibili.app.dynamic.v2.MdlDynLive.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): bilibili.app.dynamic.v2.MdlDynLive = _builder.build()
    ...
    public val MdlDynLiveKt.Dsl.badgeOrNull: bilibili.app.dynamic.v2.VideoBadge?
...
@kotlin.jvm.JvmSynthetic
public inline fun bilibili.app.dynamic.v2.MdlDynLive.copy(block: `bilibili.app.dynamic.v2`.MdlDynLiveKt.Dsl.() -> kotlin.Unit): bilibili.app.dynamic.v2.MdlDynLive =
  `bilibili.app.dynamic.v2`.MdlDynLiveKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val bilibili.app.dynamic.v2.MdlDynLiveOrBuilder.badgeOrNull: bilibili.app.dynamic.v2.VideoBadge?
