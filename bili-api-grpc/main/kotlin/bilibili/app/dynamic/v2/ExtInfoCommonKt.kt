...
public inline fun extInfoCommon(block: bilibili.app.dynamic.v2.ExtInfoCommonKt.Dsl.() -> kotlin.Unit): bilibili.app.dynamic.v2.ExtInfoCommon =
  bilibili.app.dynamic.v2.ExtInfoCommonKt.Dsl._create(bilibili.app.dynamic.v2.ExtInfoCommon.newBuilder()).apply { block() }._build()
/**
 * ```
 * 动态-拓展小卡模块-通用小卡
 * ```
 *
 * Protobuf type `bilibili.app.dynamic.v2.ExtInfoCommon`
 */
public object ExtInfoCommonKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: bilibili.app.dynamic.v2.ExtInfoCommon.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: bilibili.app.dynamic.v2.ExtInfoCommon.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): bilibili.app.dynamic.v2.ExtInfoCommon = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun bilibili.app.dynamic.v2.ExtInfoCommon.copy(block: `bilibili.app.dynamic.v2`.ExtInfoCommonKt.Dsl.() -> kotlin.Unit): bilibili.app.dynamic.v2.ExtInfoCommon =
  `bilibili.app.dynamic.v2`.ExtInfoCommonKt.Dsl._create(this.toBuilder()).apply { block() }._build()
