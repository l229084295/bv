...
public inline fun mdlDynArticle(block: bilibili.app.dynamic.v2.MdlDynArticleKt.Dsl.() -> kotlin.Unit): bilibili.app.dynamic.v2.MdlDynArticle =
  bilibili.app.dynamic.v2.MdlDynArticleKt.Dsl._create(bilibili.app.dynamic.v2.MdlDynArticle.newBuilder()).apply { block() }._build()
/**
 * ```
 * 动态列表渲染部分-详情模块-专栏模块
 * ```
 *
 * Protobuf type `bilibili.app.dynamic.v2.MdlDynArticle`
 */
public object MdlDynArticleKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: bilibili.app.dynamic.v2.MdlDynArticle.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: bilibili.app.dynamic.v2.MdlDynArticle.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): bilibili.app.dynamic.v2.MdlDynArticle = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun bilibili.app.dynamic.v2.MdlDynArticle.copy(block: `bilibili.app.dynamic.v2`.MdlDynArticleKt.Dsl.() -> kotlin.Unit): bilibili.app.dynamic.v2.MdlDynArticle =
  `bilibili.app.dynamic.v2`.MdlDynArticleKt.Dsl._create(this.toBuilder()).apply { block() }._build()
