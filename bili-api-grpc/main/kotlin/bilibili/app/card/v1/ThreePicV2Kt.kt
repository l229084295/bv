...
@kotlin.jvm.JvmName("-initializethreePicV2")
public inline fun threePicV2(block: bilibili.app.card.v1.ThreePicV2Kt.Dsl.() -> kotlin.Unit): bilibili.app.card.v1.ThreePicV2 =
  bilibili.app.card.v1.ThreePicV2Kt.Dsl._create(bilibili.app.card.v1.ThreePicV2.newBuilder()).apply { block() }._build()
/**
 * ```
 * ```
 *
 * Protobuf type `bilibili.app.card.v1.ThreePicV2`
 */
public object ThreePicV2Kt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: bilibili.app.card.v1.ThreePicV2.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: bilibili.app.card.v1.ThreePicV2.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): bilibili.app.card.v1.ThreePicV2 = _builder.build()
    ...
    public val ThreePicV2Kt.Dsl.baseOrNull: bilibili.app.card.v1.Base?
    ...
    public val ThreePicV2Kt.Dsl.avatarOrNull: bilibili.app.card.v1.Avatar?
     ...
     * ```
     *
     * `.bilibili.app.card.v1.ReasonStyle rcmd_reason_style = 16;`
     */
    ...
    public val ThreePicV2Kt.Dsl.rcmdReasonStyleOrNull: bilibili.app.card.v1.ReasonStyle?
      get() = _builder.rcmdReasonStyleOrNull
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun bilibili.app.card.v1.ThreePicV2.copy(block: `bilibili.app.card.v1`.ThreePicV2Kt.Dsl.() -> kotlin.Unit): bilibili.app.card.v1.ThreePicV2 =
  `bilibili.app.card.v1`.ThreePicV2Kt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val bilibili.app.card.v1.ThreePicV2OrBuilder.baseOrNull: bilibili.app.card.v1.Base?
  get() = if (hasBase()) getBase() else null

public val bilibili.app.card.v1.ThreePicV2OrBuilder.avatarOrNull: bilibili.app.card.v1.Avatar?
  get() = if (hasAvatar()) getAvatar() else null

public val bilibili.app.card.v1.ThreePicV2OrBuilder.rcmdReasonStyleOrNull: bilibili.app.card.v1.ReasonStyle?
