...
public inline fun danmuPlayerConfig(block: bilibili.tv.interfaces.dm.v1.DanmuPlayerConfigKt.Dsl.() -> kotlin.Unit): bilibili.tv.interfaces.dm.v1.DanmuPlayerConfig =
  bilibili.tv.interfaces.dm.v1.DanmuPlayerConfigKt.Dsl._create(bilibili.tv.interfaces.dm.v1.DanmuPlayerConfig.newBuilder()).apply { block() }._build()
/**
 * ```
 * 弹幕配置
 * ```
 *
 * Protobuf type `bilibili.tv.interfaces.dm.v1.DanmuPlayerConfig`
 */
public object DanmuPlayerConfigKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: bilibili.tv.interfaces.dm.v1.DanmuPlayerConfig.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: bilibili.tv.interfaces.dm.v1.DanmuPlayerConfig.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): bilibili.tv.interfaces.dm.v1.DanmuPlayerConfig = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun bilibili.tv.interfaces.dm.v1.DanmuPlayerConfig.copy(block: `bilibili.tv.interfaces.dm.v1`.DanmuPlayerConfigKt.Dsl.() -> kotlin.Unit): bilibili.tv.interfaces.dm.v1.DanmuPlayerConfig =
  `bilibili.tv.interfaces.dm.v1`.DanmuPlayerConfigKt.Dsl._create(this.toBuilder()).apply { block() }._build()
