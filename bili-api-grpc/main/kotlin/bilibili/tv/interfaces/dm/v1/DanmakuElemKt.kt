...
public inline fun danmakuElem(block: bilibili.tv.interfaces.dm.v1.DanmakuElemKt.Dsl.() -> kotlin.Unit): bilibili.tv.interfaces.dm.v1.DanmakuElem =
  bilibili.tv.interfaces.dm.v1.DanmakuElemKt.Dsl._create(bilibili.tv.interfaces.dm.v1.DanmakuElem.newBuilder()).apply { block() }._build()
/**
 * ```
 * 弹幕条目
 * ```
 *
 * Protobuf type `bilibili.tv.interfaces.dm.v1.DanmakuElem`
 */
public object DanmakuElemKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: bilibili.tv.interfaces.dm.v1.DanmakuElem.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: bilibili.tv.interfaces.dm.v1.DanmakuElem.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): bilibili.tv.interfaces.dm.v1.DanmakuElem = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun bilibili.tv.interfaces.dm.v1.DanmakuElem.copy(block: `bilibili.tv.interfaces.dm.v1`.DanmakuElemKt.Dsl.() -> kotlin.Unit): bilibili.tv.interfaces.dm.v1.DanmakuElem =
  `bilibili.tv.interfaces.dm.v1`.DanmakuElemKt.Dsl._create(this.toBuilder()).apply { block() }._build()
