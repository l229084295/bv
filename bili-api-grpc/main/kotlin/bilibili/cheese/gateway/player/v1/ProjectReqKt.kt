...
public inline fun projectReq(block: bilibili.cheese.gateway.player.v1.ProjectReqKt.Dsl.() -> kotlin.Unit): bilibili.cheese.gateway.player.v1.ProjectReq =
  bilibili.cheese.gateway.player.v1.ProjectReqKt.Dsl._create(bilibili.cheese.gateway.player.v1.ProjectReq.newBuilder()).apply { block() }._build()
/**
 * ```
 * 投屏地址-请求
 * ```
 *
 * Protobuf type `bilibili.cheese.gateway.player.v1.ProjectReq`
 */
public object ProjectReqKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: bilibili.cheese.gateway.player.v1.ProjectReq.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: bilibili.cheese.gateway.player.v1.ProjectReq.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): bilibili.cheese.gateway.player.v1.ProjectReq = _builder.build()
     ...
     * `bool flv_proj = 13;`
     */
    public var flvProj: kotlin.Boolean
      @JvmName("getFlvProj")
      get() = _builder.getFlvProj()
      @JvmName("setFlvProj")
      set(value) {
        _builder.setFlvProj(value)
      }
    /**
     * ```
     * 是否flv格式
     ...
     * `bool flv_proj = 13;`
     */
    public fun clearFlvProj() {
      _builder.clearFlvProj()
    }
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun bilibili.cheese.gateway.player.v1.ProjectReq.copy(block: `bilibili.cheese.gateway.player.v1`.ProjectReqKt.Dsl.() -> kotlin.Unit): bilibili.cheese.gateway.player.v1.ProjectReq =
  `bilibili.cheese.gateway.player.v1`.ProjectReqKt.Dsl._create(this.toBuilder()).apply { block() }._build()
